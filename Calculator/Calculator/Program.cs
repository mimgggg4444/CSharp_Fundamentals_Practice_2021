...
namespace Calculator
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("result3 uint - : " + result3);

            int num3 = int.MaxValue;
            int result4 = num3 + 1;

            Console.WriteLine("result4 overflow : " + result4);

            float num4 = 2.3f;

            float result5 = num1 + num4;
            float result6 = num2 + num1;

            Console.WriteLine("result5 float + : " + result5);
            Console.WriteLine("result6 float + : " + result6);
            ...
            Console.WriteLine("result9 float / : " + result9);
